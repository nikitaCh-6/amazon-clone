...
import { loadStripe } from "@stripe/stripe-js";   // the package is an official JavaScript library provided by Stripe, which is used for integrating Stripe's payment processing functionality into a web application. terminal command- 'npm install @stripe/stripe-js'. 
import { useSession } from "next-auth/react";  // the package is a part of the NextAuth.js library, which provides authentication for Next.js applications. terminal command- 'npm install next-auth@beta'. 
