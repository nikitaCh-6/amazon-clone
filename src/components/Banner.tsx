...
import { Carousel }  from 'react-responsive-carousel';  //Installed the package from terminal using command as 'npm i react-responsive-carousel'. it is use to Swipe the slide.
